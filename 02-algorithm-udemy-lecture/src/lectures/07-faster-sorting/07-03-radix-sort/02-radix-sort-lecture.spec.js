import { getDigit, digitCount, mostDigits, radixSort } from './02-radix-sort-lecture';

describe('07-03 / 01-radix-sort-lecture', () => {
  describe('getRadixValue()', () => {
    it('getRadixValue(123, 0) === 3', () => {
      const result = getDigit(123, 0);

      expect(result).toBe(3);
    });

    it('getRadixValue(123, 2) === 1', () => {
      const result = getDigit(123, 2);

      expect(result).toBe(1);
    });

    it('getRadixValue(123, 3) === 0', () => {
      const result = getDigit(123, 3);

      expect(result).toBe(0);
    });

    it('getRadixValue(123, 4) === 0', () => {
      const result = getDigit(123, 4);
